  ...
  return (
    <div className="w-1/3 bg-[#F3D250] border-r-8 border-black flex flex-col items-center relative">
      <div className="h-[10svh] w-full flex items-center justify-center">
        <div className="w-1/2 h-3/5  bg-black bg-opacity-25 text-white rounded-xl text-[1rem]  xl:text-[1.5rem]  flex items-center justify-center">
          Your Doggo Farm
        </div>
      </div>

      <div className="w-full h-[8svh] bg-black bg-opacity-40 text-white py-3 flex flex-col justify-center items-center">
        <div className="text-[1rem] lg:text-[1.2rem] xl:text-[1.5rem]">{Math.floor(props.doggosNumber)} DOGGOS</div>
        <div className="text-[0.8rem] lg:text-[1rem] xl:text-[1rem]">CLICK - {props.clickAdd} DOG</div>
      </div>
